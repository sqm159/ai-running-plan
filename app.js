...
function drawRadarChart(canvasId, currentScores, targetScores) {
  ...
  drawPolygon(currentScores, "rgba(217,238,99,0.18)", "rgba(217,238,99,0.95)", 2.5);
...
function renderPrivacyPage(app) {
  app.innerHTML = `
    <section class="page legal-page">
      ...
      <h3>我们收集什么</h3>
      <p>你注册或登录时，我们会保存邮箱，或把手机号做成内部账号标识。你主动填写的运动档案（如昵称、年龄、身高、体重、训练目标），以及成绩、训练日志和能力分析，也会保存在你的账户下。</p>
      <h3>这些数据用来做什么</h3>
